      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                ...
                <div >
                   <p class="latesthead">RollSide Privacy</p> 
                    <hr>
                </div>   
                             ...
                             <div>                 
                                   ...
                                   <p class="priv">
                                       The RollSide Music is completely committed to the privacy of the users and its customers. The 
                                       songs, tunes and albums are for sole purpose of sharing and listening, that will create value to music 
                                       and its owner.
                                       <br><br>                                       
                                       All the music is shareable on the site and its remains in the space; user has the priviledge to download, make palylist and follow their favorite artists. The user is solely responsible for sharing the music on the network and on the RollSide.
                                       <br><br>                                       
                                       The users which are going for uploading professional content can go for sharing their music on the RollSide.The pro user has to sign agreement for providing sharing rights and is solely responsible for sharing it on the RollSide under terms of the agreement.<br> The user must share his/her own original content as per the agreement and will solely responsible for fraud in sharing the content.<br>
                                       The content shared is free for sharing, listening and downloading by the users of RollSide.
                                       <br><br>
                                        The sharing person will form a channel for sharing content. For any query <a href="contactus.php"> contact us.</a>
                                       <br><br>
                                        To change password of the account, please go to <a href="user.php">User.</a>
                                 </p>
                          </div>  
