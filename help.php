      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
            ...
            <p class="latesthead">RollSide Help</p>
            <hr>
                           <div>                              
                                 <p class="priv">
                                   Always ready for providing help and support to our users. Please see the topics with respect to the query.<br> 
                                   <br>
                                     Download, Like &amp;  Follow:<br>
                                     1. The downloading occur at single click of download button without any further redirection.<br>
                                     2. Like feature is restricted on user's account, all the liked tracks or albums are added to the users playlist.<br>
                                     3. Follow your favorite artists and get updates of their new songs.
                                     <br><br>
                                     Uploading:<br>
                                     1. The uploading features is constrained under copyright details. Uploaded content will not be considered if the matter has disputed or incomplete copyright issues.<br>
                                     2. At RollSide the content is free to download and listen, the same is listed in the agreement. <br>
                                     3. It is preffered that the uploader should complete and accurate details about the content, that will be helpful in promotion and reaching the audience.<br>
                                     4. The agreement is necessary for uploading and consideration for distributing on the RollSide.<br><br>
                                     
                                     There may be quite a few things which may have been left. If anything you feel is still need to be clearified; please <a href="contactus.html">contact us</a>.
