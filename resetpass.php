...
if(isset($_SESSION["bool"]))
{    
    if($_SESSION["bool"]==1 || $_SESSION["bool"]!="")
    {
 ...
 <div class="modal fade" id="msg-modal" role="dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                ...
                <div >
                   <p class="latesthead">Reset Password</p> 
                    <hr>
                </div>
    ...
    <div class="container-fluid " >
            ...
            <div class="col-md-2">
             ...
             <p class="option" >Options</p><br><br>
                <ul class="oplist">                
        ...
        <p style = "color:grey; font-size: 18px; " >Please provide the email which is registered in the RollSide Account,otherwise request will be discarded.<br> A new password will be mailed to the registered email and later you can change the password.</p>
                
                <hr>
    <div class = "form-group">
 <form method="post" id="passform">
      
     <label for = "password" class = "col-sm-2 control-label" style = "color:grey;font-size:18px; " >Email*</label>		
      <div class = "col-sm-4">
         <input type="text" class = "form-control" name = "email" placeholder = "email" required="required">
      </div><br><br><br>       
        
        <div class = "col-sm-3" style="padding-left:270px !important;">
        <input type="submit"  id="changepass"   class="btn btn-primary" style="font-size:18px;" value="Reset Password" >
        </div>
            <br><br><br>
             <label id="signMsg"></label>
</form>
        <script type="text/javascript">
                    ...
                    $.post("PHP/Script/ResetPass.php",$("#passform").serialize()).done(function(resp,status){      
                   var label= document.getElementById('signMsg'); 
                    label.innerHTML=resp;
                        resp=resp.trim();
                          if(resp==1)
                              {
                                var res="Mail Sent. Password is reset";
                                label.innerHTML=res;
                                label.style.color="green";
                                location.reload(true);  
                              }
                          else{
                                var res="Password could not be reset, please try again";
                                label.innerHTML=res;
                              label.style.color="red";
                          }
