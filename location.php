...
<div class="modal fade" id="login-modal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
 ...
 <div class="modal fade" id="msg-modal" role="dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
            ...
            <p class="latesthead">RollSide Map Location</p>
            <hr>
            <p class="priv">
            LOCATION: National Institute of Technology, Jalandhar,144011<br>
            STATE: Punjab, India<br>
            CONTACT: roll@rollside.com<br>
            </p>
        <hr>
    ...
    <script>
      function initMap() {
        var uluru = {lat: 31.39723855, lng: 75.5367136};
    ...
    <script async defer
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCKzH7Q4akcLI0B6HaFJAkl60OHJcFsat4&callback=initMap">
    </script>
