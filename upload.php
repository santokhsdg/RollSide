 ...
 <div class="modal fade" id="msg-modal" role="dialog">
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <h4 style="color:red;">You Need to activate your account by verifying your email, only then songs can be uploaded.</h4>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
        </div>
    ...
    <div class="ppl">
        <h2 class="content">Upload!    Share!    Increase!</h2>
    </div>
    <div>
        <p class="content1">Create a free RollSide account to get started</p>
    </div>
    <div class="container-fixed">
        
        <div class="col-md-4">
        <div class="images" >
            <img  src="Images/478677661.jpg">
        </div>
    </div>
        <div class="col-md-4">
        <div class="images" >
    ...
    <div class="col-md-4">
        <div class="content3"  >
            <p> Enjoy space for 100 songs for your uploads, quite a lot free for
multiple albums</p>
        </div>
    </div>
    ...
    <div class="col-md-4">
        <div class="content3">
            <p>Share your voice with your community and world. Get likes and followers, show your talent</p>
        </div>
    </div>
     
    <div class="col-md-4">
        <div class="content3"  >
            <p>Quantify your fame and success, come to the top.</p>
        </div>
    </div>
             ...
             <ul class="signl" >
                 <li>
                     <a <?php if(isset($_SESSION["bool"])){
                        ...
                        class="btn btn-primary center-block btn-dl" >Upload</a>
                </li>
            </ul>
                 </div>
